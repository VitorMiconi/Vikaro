...
const StairsSection = () => {
    return (
        <div className="text-white w-full lg:h-screen px-6 flex pb-6 bg-none lg:bg-custom-stairs bg-no-repeat bg-cover flex flex-col items-center  gap-4 lg:gap-0">
            <img className="flex lg:hidden" src="../img/stairs.png"></img>
