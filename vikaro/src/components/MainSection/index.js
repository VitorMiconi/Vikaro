    ...
    return (
        <div className="bg-black w-full h-screen flex flex-col justify-end items-center text-white">
            ...
            <img className="absolute left-0 top-40 hidden lg:block" src="/img/main-star.png" alt="Vikaro Star"></img>
                <div className='flex flex-col items-center gap-2 lg:gap-6 z-50'>
                <h2 className='font-analogist text-xl lg:text-4xl'>( DESENVOLVIMENTO FRONT-END )</h2>
                <div className='flex items-center gap-2'>
                    <p className='font-analogist absolute mt-20 ml-12 lg:ml-36 lg:mt-40 text-xl lg:text-4xl'>by</p>
